...
$(document).ready( function(){
  ...
  $('#btn_iniciar_jogo').click( function(){
    ...
    if($('#entrada_apelido_jogador_2').val() == ''){
      alert('Apelido do jogador 2 não foi preechido');
      return false;
    }
    ...
    $('#pagina_inicial').hide();$('#reiniciar').show();
    $('#palco_jogo').show();
    $('#reiniciar').hide();
  });
  ...
  function ganhador(pontos){
    if(pontos == -3){
      ...
      alert('O jogador '+jogador_1+' é o vencedor');
      $('.jogada').off();
      $('#reiniciar').show();
    } else if(pontos == 3){
        var jogador_2 = $('#entrada_apelido_jogador_2').val();
        alert('O jogador '+jogador_2+' é o vencedor');
        $('.jogada').off();
        $('#reiniciar').show();
    }
  }
